 ...
 * вкладку не прячет.
 *
 * Раньше раздел был жестко закрыт администраторам: назначать их было нельзя,
 * и вкладка у них всегда пустовала. Теперь ответственным может стать любой
 * сотрудник, и условие работает само — у администратора без задач вкладки
 * по-прежнему нет, а с первой назначенной она появляется.
 */
